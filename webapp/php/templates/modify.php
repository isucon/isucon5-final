...
<body>
<div class="container" data-grade="<?php h($user['grade']) ?>">
  <div class="header clearfix">
    ...
    <h3 class="text-muted">AirISU 設定変更: <?php h($user['email']) ?></h3>
  </div>
  ...
  <div class="api-form" data-grade="micro,small,standard,premium" data-api-name="名前API" data-service="givenname" data-param-name="q" data-param-desc="クエリ"></div>
